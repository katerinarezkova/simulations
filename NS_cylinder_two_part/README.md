...
| File | Purpose |
| :--- | :--- |
| `ns_cylinder_fire.py` | Main Firedrake script. Runs the solver and exports numerical data. |
| `plot_results.py` | Post-processing script. Reads saved data and generates PDF plots. |
| `force_data.txt` | Output text file containing Drag ($C_D$) and Lift ($C_L$) coefficients. |
